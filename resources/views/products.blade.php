...
<body>
    <section id="box">
                        ...
                        <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <div class="addInput">
                                    ...
                                    <input type="text" class="input-box" name="category">
                                </div>
                                <div class="addInput">
                                ...
                                <div class="addInput">
                                    ...
                                    <div class="harga">
                                        <label>Rp.</label>
                                        <input type="number" min="1" class="input-price" name="price">
                                    </div>
                                </div>
                                <div class="addInput">
                                    <label> Product Stock</label>
                                    <input type="number" min="0" class="input-box" name="stock">
                                </div>
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-primary" onclick="validate()">Upload</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="content">
            ...
            <div class="user">
                <div class="top">
                    <a href="{{ route('product.show', $product->id) }}"><img src="{{asset('storage/image/'.$product->image)}}" alt=""></a>
